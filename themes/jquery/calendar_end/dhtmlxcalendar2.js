if(typeof(window.dhx4)=="undefined"){
	window.dhx4={version:"4.2",skin:null,skinDetect:function(a){
		return{10:"dhx_skyblue",20:"dhx_web",30:"dhx_terrace"}[this.readFromCss(a+"_skin_detect")]||null},readFromCss:function(c,d){
			...
			return a
				...
				return 100
			},last:function(){var c=this.first();
					for(var b in this.data){c=Math.max(c,this.data[b])}return c},reserve:function(a){this.data[a]=this.last()+this.step;
						return this.data[a]},clear:function(a){
							if(this.data[a]!=null){this.data[a]=null;
							delete this.data[a]}}},s2b:function(a){
								if(typeof(a)=="string"){
									a=a.toLowerCase()
								}
									return(a==true||a==1||a=="true"||a=="1"||a=="yes"||a=="y")},s2j:function(s){
										var obj=null;dhx4.temp=null;
										try{
											eval("dhx4.temp="+s)
										}catch(e){
											dhx4.temp=null}obj=dhx4.temp;
							dhx4.temp=null;
							return obj},absLeft:function(a){
								if(typeof(a)=="string"){a=document.getElementById(a)}return this.getOffset(a).left},absTop:function(a){
									if(typeof(a)=="string"){a=document.getElementById(a)}return this.getOffset(a).top},_aOfs:function(a){var c=0,b=0;
								while(a){c=c+parseInt(a.offsetTop)
									...
									if(a.getBoundingClientRect){return this._aOfsRect(a)
										...
										return c},screenDim:function(){
											...
											var b={};b.left=document.body.scrollLeft;b.right=b.left+(window.innerWidth||document.body.clientWidth);
											...
											return b},selectTextRange:function(d,g,b){d=(typeof(d)=="string"?document.getElementById(d):d);
											...
											if(d.setSelectionRange){
												...
												if(d.createTextRange){
													var c=d.createTextRange();c.moveStart("character",g);c.moveEnd("character",b-a);
													try{c.select()
													}catch(f){}
												}
											}
											...
											if(this.transData==null){
												...
												for(var b in c){
													if(this.transData.transProp==false&&document.documentElement.style[b]!=null){
														this.transData.transProp=b;this.transData.transEv=c[b]}}c=null}
														return this.transData},_xmlNodeValue:function(a){
															var c="";
															...
															window.dhx4.isIPad=(navigator.userAgent.search(/iPad/gi)>=0)}if(typeof(window.dhx4.template)=="undefined"){window.dhx4.trim=function(a){
																return String(a).replace(/^\s{1,}/,"").replace(/\s{1,}$/,"")};
																window.dhx4.template=function(b,c,a){return b.replace(/#([a-z0-9_-]{1,})(\|([^#]*))?#/gi,function(){
																	var g=arguments[1];
																	var f=window.dhx4.trim(arguments[3]);
																	var h=null;
																	var e=[c[g]];
																	if(f.length>0){f=f.split(":");
																	var d=[];
																	for(var i=0;i<f.length;i++){
																		if(i>0&&d[d.length-1].match(/\\$/)!=null){d[d.length-1]=d[d.length-1].replace(/\\$/,"")+":"+f[i]
																	}else{
																		d.push(f[i])}}h=d[0];
																		...
																		if(typeof(h)=="string"&&typeof(window.dhx4.template[h])=="function"){
																			...
																			if(g.length>0&&typeof(c[g])!="undefined"){
																				if(a==true){
																					return window.dhx4.trim(c[g])}return String(c[g])}return""})
															};
																window.dhx4.template.date=function(a,b){if(a!=null){
										...
										window.dhx4.template.number_format=function(d,e,c,a){
											...
											window.dhx4.template.lowercase=function(a){
												if(typeof(a)=="undefined"||a==null){a=""}
													return String(a).toLowerCase()};window.dhx4.template.uppercase=function(a){
														if(typeof(a)=="undefined"||a==null){a=""}
															return String(a).toUpperCase()};
														window.dhx4.template._parseFmt=function(h,c,a){
															var d=h.match(/^([^\.\,0-9]*)([0\.\,]*)([^\.\,0-9]*)/);if(d==null||d.length!=4){
																return false
															}
								...
								var g=d[2].split(".");if(g[1]!=null){b.d_len=g[1].length}var e=g[0].split(",");if(e.length>1){b.i_len=e[e.length-1].length}return b};
								window.dhx4.template._getFmtValue=function(value,fmt){
									var r=String(value).match(/^(-)?([0-9]{1,})(\.([0-9]{1,}))?$/);
									if(r!=null&&r.length==5){var v0="";
									if(r[1]!=null){v0+=r[1]}v0+=fmt.s_bef;
									if(fmt.i_len!==false){
										var i=0;var v1="";
									for(var q=r[2].length-1;q>=0;q--){
										...
										if(fmt.d_len!==false){
											if(r[4]==null){r[4]=""}
												while(r[4].length<fmt.d_len){r[4]+="0"}eval("dhx4.temp = new RegExp(/\\d{"+fmt.d_len+"}/);");
											var t1=(r[4]).match(dhx4.temp);
											if(t1!=null){v0+=fmt.d_sep+t1}dhx4.temp=t1=null}v0+=fmt.s_aft;return v0}return value}
										}
											if(typeof(window.dhx4.dateLang)=="undefined"){window.dhx4.dateLang="en";

			// init values
								window.dhx4.dateStrings={en:{monthFullName:["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre"],monthShortName:["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Set","Oct","Nov","Dic"],dayFullName:["Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado"],dayShortName:["Do","Lu","Ma","Mi","Ju","Vi","Sa"]}};
								...
								window.dhx4.date2str=function(f,d,a){
									if(d==null||typeof(d)=="undefnied"){
										...
										if(a==null||typeof(a)=="undefnied"){
											...
											if(f instanceof Date){var e=function(g){
												...
												return(c||String(f))};window.dhx4.str2date=function(g,s,x){
													if(s==null||typeof(s)=="undefnied"){s=window.dhx4.dateFormat[window.dhx4.dateLang]}
														if(x==null||typeof(x)=="undefnied"){
															x=window.dhx4.dateStrings[window.dhx4.dateLang]}s=s.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\\:|]/g,"\\$&");
															var u=[];var j=[];s=s.replace(/%[a-z]/gi,function(e){
																switch(e){
																	case"%d":case"%m":case"%y":case"%h":case"%H":case"%i":case"%s":j.push(e);return"(\\d{2})";
																	case"%D":case"%l":case"%M":case"%F":j.push(e);return"([a-zéûä\u0430-\u044F\u0451]{1,})";
																	case"%j":case"%n":case"%g":case"%G":j.push(e);return"(\\d{1,2})";case"%Y":j.push(e);return"(\\d{4})";
																	case"%a":j.push(e);return"([am|pm])";case"%A":j.push(e);return"([AM|PM])";
																	case"%u":j.push(e);return"(\\d{1,6})";
																	case"%P":j.push(e);return"([+-]\\d{1,2}:\\d{1,2})"}return e});
															var y=new RegExp(s,"i");var l=g.match(y);if(l==null||l.length-1!=j.length){
																return"Invalid Date"}
																...
																for(var b=0;b<j.length;b++){
																	if(typeof(c[j[b]])!="undefined"){
																		var d=c[j[b]];
																		if(!m[d]){m[d]=[];i[d]=[]}m[d].push(u[b]);i[d].push(j[b])}}u=[];j=[];
																		for(var b=1;b<=7;b++){if(m[b]!=null){
																			for(var o=0;o<m[b].length;o++){u.push(m[b][o]);j.push(i[b][o])}}}
																				var a=new Date();a.setDate(1);
																			a.setHours(0);
																			a.setMinutes(0);
																			a.setSeconds(0);
																			a.setMilliseconds(0);
																			var n=function(k,e){
																				for(var f=0;f<e.length;f++){
																					if(e[f].toLowerCase()==k){return f}}return -1};
																					for(var b=0;b<u.length;b++){
																						switch(j[b]){
																							case"%d":case"%j":case"%n":case"%m":case"%Y":case"%H":case"%G":case"%i":case"%s":case"%u":
																							if(!isNaN(u[b])){a[{"%d":"setDate","%j":"setDate","%n":"setMonth","%m":"setMonth","%Y":"setFullYear","%H":"setHours","%G":"setHours","%i":"setMinutes","%s":"setSeconds","%u":"setMilliseconds"}[j[b]]](Number(u[b])+(j[b]=="%m"||j[b]=="%n"?-1:0))}break;
																							case"%M":case"%F":var h=n(u[b].toLowerCase(),x[{"%M":"monthShortName","%F":"monthFullName"}[j[b]]]);
																							if(h>=0){a.setMonth(h)}break;
										...
										if(this._strToDate!=null){
											...
											var m=String(this._dateFormat).replace(/%[a-zA-Z]+/g,function(a){
												...
												switch(q){
													...
													case"D":return"[a-z]{2}";case"a":case"A":return"AM|PM";case"u":return"\\d{1,6}";case"P":return"[\\+\\-]\\d{1,2}\\:\\d{1,2}"
												}
												return a});this._dateFormatRE=new RegExp(m,"i");
											for(var l in n){
												this.i[l].input.value=this._dateToStr(n[l])
											}n=null};
											this.setDateFormat(this.langData[this.lang].dateformat||"%Y-%m-%d");
											this._updateDateStr=function(l){if(!this._dateFormatRE||!l.match(this._dateFormatRE)){
												return
											}
										...
										this.showMonth=function(a){
											...
											this.setFormatedDate=function(o,p,l,n){
												...
												this.getFormatedDate=function(l,a){
													...
													return this._dateToStr(a,l)};this.getWeekNumber=function(p){
														if(typeof(p)=="string"){
															p=this._strToDate(p)
														}
														if(!(p instanceof Date)){
														...
														if(w==0){
															...
															var a=q.getDay()-this._wStart;if(a<0){a=a+7}q.setDate(q.getDate()-a);w=this.getWeekNumber(q)
														}
														return w
													};
													...
													this.show=function(m){
														if(!m&&this._hasParent){this._show();
															return}
															...
															if(typeof(m)=="undefined"){
																for(var l in this.i){
																	if(!m){
																		...
																		this._show(m)};this.hide=function(){
																			if(this._isVisible()){this._hide()}};this.isVisible=function(){
																				...
																				this.setPosition=function(a,l){
																					...
																					if(a=="right"||a=="bottom"){
																						...
																						if(typeof(a)!="undefined"&&!isNaN(a)){
																							this.base.style.left=a+"px";this._px=a
																						}
																							if(typeof(l)!="undefined"&&!isNaN(l)){
																								this.base.style.top=l+"px";this._py=l
																							}
																							this._ifrSize()}};this._show=function(q,a){
									...
									if(this._ifr){
										...
										{this._hideSelector();
											...
											if(this.base.className.indexOf("dhtmlxcalendar_in_input")>=0){
												this.base.className=this.base.className.replace(/\s{0,}dhtmlxcalendar_in_input/gi,"")}this._activeInp=null;
												if(this._ifr){this._ifr.style.display="none"}this.callEvent("onHide",[])};
												this._isVisible=function(){return(this.base.style.display!="none")};
												this._getLeft=function(a){return this._posGetOffset(a).left};
												this._getTop=function(a){return this._posGetOffset(a).top};
												this._posGetOffsetSum=function(a){var m=0,l=0;
													while(a){m=m+parseInt(a.offsetTop);l=l+parseInt(a.offsetLeft);a=a.offsetParent}
													return{top:m,left:l}};this._posGetOffsetRect=function(n){
														...
														var t=q.top+a-p;var m=q.left+o-s;
																				...
																				if(l!=null){
																					...
																					for(var m=0;m<a.length;m++){
																						...
																						this._extractDates=function(m){
																							if(typeof(m)=="string"||m instanceof Date){m=[m]}var l=[];
																							for(var n=0;n<m.length;n++){
																								if(typeof(m[n])=="string"){var o=m[n].split(",");
																								for(var a=0;a<o.length;a++){l.push(this._strToDate(o[a]))}}
																								else{if(m[n] instanceof Date){l.push(m[n])}}}
																								return l};
																									...
																									this._clearRangeSet=function(){
																										for(var l in this._rangeSet){
																											...
																											this._clearHolidays=function(){
																												for(var l in this._holidays){this._holidays[l]=null;
																																...
																																if(this._rangeType=="in"&&(l<this._rangeFrom||l>this._rangeTo)){
																																	...
																																	if(this._rangeType=="out"&&(l>=this._rangeFrom&&l<=this._rangeTo)){
																																		...
																																		if(this._rangeType=="from"&&l<this._rangeFrom){
																																			return true}if(this._rangeType=="to"&&l>this._rangeTo){
																																				return true}}var a=new Date(l);
																																				if(this._rangeWeek){
																																								...
																																								return true}}if(this._rangeYear){
																																									if(this._rangeYearData[a.getMonth()+"_"+a.getDate()]===true){
																																										...
																																										this.setSensitiveRange=function(n,m,a){
																																											var l=false;if(n!=null&&m!=null){
																																												if(!(n instanceof Date)){n=this._strToDate(n)}
																																												if(!(m instanceof Date)){m=this._strToDate(m)}
																																												if(n.getTime()>m.getTime()){
																																													...
																																													this._rangeActive=true;this._rangeType="in";l=true}
																																													if(!l&&n!=null&&m==null){
																																														if(!(n instanceof Date)){n=this._strToDate(n)}
																																														...
																																														this._rangeTo=null;if(a===true){this._rangeFrom++}this._rangeActive=true;
																																														this._rangeType="from";l=true}if(!l&&n==null&&m!=null){
																																															if(!(m instanceof Date)){m=this._strToDate(m)}this._rangeFrom=null;
																																															this._rangeTo=new Date(m.getFullYear(),m.getMonth(),m.getDate(),0,0,0,0).getTime();
																																															if(a===true){this._rangeTo--}this._rangeActive=true;
																																															this._rangeType="to";l=true}if(l){this._drawMonth(this._activeMonth)}};
																																															this.setInsensitiveRange=function(l,a){
																																																if(l!=null&&a!=null){
																																																	if(!(l instanceof Date)){l=this._strToDate(l)}
																																																	if(!(a instanceof Date)){a=this._strToDate(a)}
																																																	if(l.getTime()>a.getTime()){return}
																																																	...
																																																	this._rangeActive=true;this._rangeType="out";this._drawMonth(this._activeMonth);
																																																	return}if(l!=null&&a==null){this.setSensitiveRange(null,l,true);
																																																		return}
																																																		if(l==null&&a!=null){this.setSensitiveRange(a,null,true);
																																																			return}};this.disableDays=function(p,o){if(p=="week"){
																																																				if(typeof(o)!="object"&&typeof(o.length)=="undefined"){o=[o]}
																																																				if(!this._rangeWeekData){this._rangeWeekData={}}
																																																				for(var l in this._rangeWeekData){this._rangeWeekData[l]=false;
																																																					delete this._rangeWeekData[l]}
																																																					for(var n=0;n<o.length;n++){this._rangeWeekData[o[n]]=true;
																																																						if(o[n]==7){this._rangeWeekData[0]=true}}this._rangeWeek=true}
																																																						if(p=="month"){
																																																							if(typeof(o)!="object"&&typeof(o.length)=="undefined"){o=[o]}
																																																							if(!this._rangeMonthData){this._rangeMonthData={}}
																																																							for(var l in this._rangeMonthData){this._rangeMonthData[l]=false;
																																																								delete this._rangeMonthData[l]}
																																																								for(var n=0;n<o.length;n++){
																																																									this._rangeMonthData[o[n]]=true}this._rangeMonth=true}
																																																									if(p=="year"){var m=this._extractDates(o);
