<section class='content-general'>
	...
	<form method="post" name="registrar">
		<section class='left' style='width:50%'>Empresa: SOLICITUD DE PERMISOS VIGILANCIA</section>
		<section class='right'>
			<a href="admin">
			...
			<section class='acceso' style="background-image: url('../themes/images/excel.png');">
				<input type='button' class="exp_permisos_vigilancia" name="boton" value='Excel' id='btn2'>
			</section>
			...
			<section class='contenido'>
				<fieldset>
					...
					<section class="form">
						<table>
							<tr>
								<td style="width:15%">Seleccione una opci&oacute;n</td>
								...
								<td style="width:6%">Nombre</td>
								<td><input type='text' class='nom_emp'></td>
								<td style="float:right"> <input type="button" class="ver_filtro" style="width:85px; height:22px" value="Filtrar"></td>
								<td></td>
							</tr>
						</table>
						</section>
						...
						<table cellpadding="0" cellspacing="0" class="tbody">
							<tbody>
								<tbody>
				                  ...
				                  <th>Asunto</th>     <th>Salida</th>                 <th>retorno</th>
				                  <th>Ejecutar</th>
				                </tbody>
							</tbody>
						</table>
