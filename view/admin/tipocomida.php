<section class='content-general'>
	...
	<form method="post" name='registrar'>
		<section class='left'>Empresa: TIPO DE COMIDA</section>
		<section class='right'>
			...
			<section class='acceso' style="background-image: url('../themes/images/excel.png');">
				<input type='button' class="exp_tipocomida" name="boton" value='Excel' id='btn2'>
			</section>
					...
					<section class="form">
						<table>
							<tr>
								...
								<td>C&oacute;digo</td>
								<td><input type='text' name='codigo' onkeypress="ValNumero(this)" maxlength="1"></td>
								<td></td>
								<td></td>
								<td></td>
								<td></td>
					...
					<table cellpadding="0" cellspacing="0">
						...
						if($_POST)
						{
							if($_POST['boton'] == "Seleccionar")
							{
								...
								if($codigo != NULL)
								{
									$query = "select * from ttico where ticocod=$codigo group by ticocod";
								}
								else
								{
									$query = "select * from ttico";
								}
				...
				<fieldset>
					<legend>Datos del Registro</legend>
						...
						<table cellspacing="0" cellpadding="0">
							<tr>
								<td>Codigo Area</td>
								<td class='td'><input type="text" name="CodMos" id="cod" class="caja3" readonly="" maxlength="1"></td>								
								<td></td><td></td><td></td>
							</tr>
							
							<tr>
								<td>Descripci&oacute;n</td>
								<td class='td'><input type="text" name="desmod" class='text1' onkeypress="ValTexto(this)" maxlength="40"></td>
							</tr>
					...
					<legend>Datos del Registro</legend>
						...
						<table cellspacing="0" cellpadding="0">
							<tr>
								...
								?>
								<td>Codigo</td>
								<td class='td'><input type="text" name="codcom" class="caja3" maxlength="1" readonly="" value=<?php echo $c; ?>></td>
								<td></td><td></td><td></td>
							</tr>
							
							<tr>
								<td>Descripci&oacute;n</td>
								<td class='td'><input type="text" name="descom" onkeypress="ValTexto(this)" maxlength="40"></td>
							</tr>
...
<?php
	if($_POST)
	{
		...
		{	
			...
			if($codmod != NULL)
			{
				$men=ValModTiCo($codmod,$_POST['desmod']);
			}
			else
			{
			    $men=ValRegTiCo($codnot,$_POST['descom']);
			}
		...
		else if ($_POST['boton'] == "Eliminar")
		{
			...
			$codtcom = $_POST['CodMos'];
			ValEliTiCo($codtcom);
		}
		else if($_POST['boton'] == trim("Excel"))
		{
			header("location:../modificar/tipocomida");
		}
	}
?>