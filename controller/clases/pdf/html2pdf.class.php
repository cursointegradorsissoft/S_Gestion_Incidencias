...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/tcpdf/clases/myPdf.class.php');
    require_once(dirname(__FILE__).'/tcpdf/clases/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/tcpdf/clases/parsingCss.class.php');
